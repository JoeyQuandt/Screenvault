      ...
      <SignIn
        appearance={{
          elements: {
            ...
            headerBackIcon: 'text-theme-red',
            headerBackLink: 'text-theme-red',
            formHeaderTitle: 'text-white',
            formHeaderSubtitle: 'text-white',
            formFieldAction:
              'text-theme-red hover:text-theme-red hover:underline',
            ...
            formFieldLabel__identifier: 'text-white opacity-50',
