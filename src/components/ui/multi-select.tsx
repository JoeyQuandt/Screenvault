            ...
            >
              {selectedValues.length > 0 ? (
                <div className='flex justify-between items-center w-full'>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <Separator
                      ...
                      className='flex min-h-6 h-full bg-theme-lightBlue'
                    />
                ...
                <div className='flex w-full items-center justify-between'>
                  ...
                  <ChevronDown className='h-8 cursor-pointer mx-2 text-theme-lightBlue' />
                </div>
              )}
            </Button>
          </PopoverTrigger>
                  ...
                  {options.map((option) => {
                    ...
                    return (
                      <CommandItem
                        ...
                        className='cursor-pointer hover:text-theme-darkBlue text-theme-white'
                      >
                        <div
                          className={cn(
                            'mr-2 flex h-4 w-4 items-center justify-center rounded-sm border border-theme-lightBlue',
                            isSelected
                              ? 'bg-primary text-theme-white'
